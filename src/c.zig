...
pub extern fn glfwCreateWindowSurface(instance: vk.Instance, window: *glfw.RawWindow, allocation_callbacks: ?*const vk.AllocationCallbacks, surface: *vk.SurfaceKHR) vk.Result;
