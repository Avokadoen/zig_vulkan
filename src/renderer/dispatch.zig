...
pub const Device = vk.DeviceWrapper([_]vk.DeviceCommand{ .AcquireNextImageKHR, .AllocateCommandBuffers, .BeginCommandBuffer, .CmdBeginRenderPass, .CmdBindPipeline, .CmdDraw, .CmdEndRenderPass, .CreateCommandPool, .CreateFence, .CreateFramebuffer, .CreateGraphicsPipelines, .CreateImageView, .CreatePipelineLayout, .CreateRenderPass, .CreateSemaphore, .CreateShaderModule, .CreateSwapchainKHR, .DestroyCommandPool, .DestroyDevice, .DestroyFence, .DestroyFramebuffer, .DestroyImageView, .DestroyPipeline, .DestroyPipelineLayout, .DestroyRenderPass, .DestroySemaphore, .DestroyShaderModule, .DestroySwapchainKHR, .EndCommandBuffer, .GetDeviceQueue, .GetSwapchainImagesKHR, .QueuePresentKHR, .QueueSubmit, .ResetFences, .WaitForFences });
