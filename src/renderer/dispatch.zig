...
pub const Device = vk.DeviceWrapper([_]vk.DeviceCommand{ .AcquireNextImageKHR, .AllocateCommandBuffers, .AllocateMemory, .BeginCommandBuffer, .BindBufferMemory, .BindImageMemory, .CmdBeginRenderPass, .CmdBindPipeline, .CmdCopyBuffer, .CmdCopyBufferToImage, .CmdCopyImageToBuffer, .CmdDraw, .CmdEndRenderPass, .CmdPipelineBarrier, .CmdSetScissor, .CmdSetViewport, .CreateBuffer, .CreateCommandPool, .CreateFence, .CreateFramebuffer, .CreateGraphicsPipelines, .CreateImage, .CreateImageView, .CreatePipelineLayout, .CreateRenderPass, .CreateSemaphore, .CreateShaderModule, .CreateSwapchainKHR, .DestroyBuffer, .DestroyCommandPool, .DestroyDevice, .DestroyFence, .DestroyFramebuffer, .DestroyImage, .DestroyImageView, .DestroyPipeline, .DestroyPipelineLayout, .DestroyRenderPass, .DestroySemaphore, .DestroyShaderModule, .DestroySwapchainKHR, .DeviceWaitIdle, .EndCommandBuffer, .FreeCommandBuffers, .FreeMemory, .GetBufferMemoryRequirements, .GetDeviceQueue, .GetImageMemoryRequirements, .GetSwapchainImagesKHR, .MapMemory, .QueuePresentKHR, .QueueSubmit, .QueueWaitIdle, .ResetFences, .UnmapMemory, .WaitForFences });
